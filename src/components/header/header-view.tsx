  ...
  return (
    <header
      className={cn(
        ...
        'before:pointer-events-none before:absolute before:inset-0 before:rounded-none before:bg-gradient-to-b before:from-white/20 before:via-white/10 before:to-transparent dark:before:from-white/10 dark:before:via-white/5 dark:before:to-transparent',
        'after:pointer-events-none after:absolute after:inset-0 after:backdrop-saturate-[180%]',
      ...
      <div className='relative z-10 flex items-center space-x-3'>
        ...
        {navigationItems.map((item) => (
          <Link
            ...
            href={item.href}
            className={cn(
              'inline-flex h-7 items-center rounded px-2 text-[11.5px] transition-colors duration-100 hover:bg-white/10 hover:text-foreground',
              pathname === item.href

...
summary: 'A Flutter-powered vehicle reservation system for corporate fleets—combining Firebase, REST APIs, and Provider state management for seamless employee experience.'
category: 'Client Project'
githubURL: 'https://github.com/salahbm'

...
summary: 'An admin dashboard for managing global recruitment content—built with Next.js 14, TanStack Table, and real-time updates.'
...
<Callout icon='💡'>
  Optimistic updates make the UI feel instant while maintaining data
  consistency. If the server request fails, React Query automatically rolls back
...
<Image
  src='/medias/mdx-content/vizamaster-admin.png'
  alt='VIZA MASTER admin dashboard with data tables'
/>
